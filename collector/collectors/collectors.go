...
const (
	...
	osMemPctUsedDesc       = "The percent of used memory. In Linux used memory does not includes memory used by buffers and cache."
...
var (
	...
	License                string // add by xuye 20160526
